...
import com.stockchain.bcapp.databinding.ActivityMainBinding;
        ...
        class NewRunnable implements Runnable {
            ...
            public void run() {
                ...
                try{
                    ...
                    board.createBoard(username, "title", "body");
                    Log.d("go", "success create board");
                } catch (IOException e) {
                    e.printStackTrace();
                    Log.d("go", "faild create board");
                }
                ...
                try{
                    ...
                    int page = board.getBoardPageCount(count);
                    ArrayList<BoardInform> listPage = board.listBoardPage(count, 1);
                    Log.d("go", "success list board");
                } catch (IOException e) {
                    e.printStackTrace();
                    Log.d("go", "faild list board");
                }
                ...
                try{
                    ...
                    BoardInform boardInform = board.getBoard(username, boardCount-1);
                    Log.d("go", "success show board");
                } catch (IOException e) {
                    e.printStackTrace();
                    Log.d("go", "faild show board");
